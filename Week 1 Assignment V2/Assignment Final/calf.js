class Calf {
    ...
    draw() {
        ...
        if (gameState === 'CALF_ESCAPING') {
            ...
            // Check if Samurai is near the calf's world position (using scaled coordinates)
            let scaledCalfDestination = CALF_DESTINATION_XPOS * gameBg.getScaleFactor(); // This value should not be changed.
            let distanceToCalfWorld = scaledCalfDestination - gameBg.getScrollPosition(); // This value should not be changed.
